...
class ASRAdapter_new:
    ...
    continuous session data, extracts the lead-in window, optionally saves it
    as an NPZ, then fits asrpy/meegkit on that array.
    """
    ...
    def initialize_from_session_leadin(
        ...
        calibration_data = data[:, :n_calib].copy()
